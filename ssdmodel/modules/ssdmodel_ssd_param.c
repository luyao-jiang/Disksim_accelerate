...
#include "../ssd.h"
#include <disksim/modules/disksim_ioqueue_param.h>
...
static int SSDMODEL_SSD_CHECKPOINT_TIME_depend(char *bv) {
return -1;
}

static void SSDMODEL_SSD_CHECKPOINT_TIME_loader(struct ssd * result, double d) { 
if (! ((d > 0.0))) { // foo 
 } 
 result->params.checkpoint_time = d;

}

static int SSDMODEL_SSD_REFRESH_INTERVAL_depend(char *bv) {
return -1;
}

static void SSDMODEL_SSD_REFRESH_INTERVAL_loader(struct ssd * result, double d) { 
if (! ((d > 0.0))) { // foo 
 } 
 result->params.refresh_interval= d;

}

static int SSDMODEL_SSD_REFRESH_POLICY_depend(char *bv) {
return -1;
}

static void SSDMODEL_SSD_REFRESH_POLICY_loader(struct ssd * result, int i) { 
if (! (RANGE(i,1,SSD_MAX_REFRESH_POLICY))) { // foo 
 } 
 result->params.refresh_policy= i;

}

static int SSDMODEL_SSD_VIRTUAL_RETENTION_PERIOD_depend(char *bv) {
return -1;
}

static void SSDMODEL_SSD_VIRTUAL_RETENTION_PERIOD_loader(struct ssd * result, double d) { 
if (! ((d > 0.0))) { // foo 
 } 
 result->params.virtual_retention_period= d;

}

static int SSDMODEL_SSD_MINIMUM_RETENTION_PERIOD_depend(char *bv) {
return -1;
}

static void SSDMODEL_SSD_MINIMUM_RETENTION_PERIOD_loader(struct ssd * result, double d) { 
if (! ((d > 0.0))) { // foo 
 } 
 result->params.min_retention_period= d;
...
(void *)SSDMODEL_SSD_CHECKPOINT_TIME_loader,
(void *)SSDMODEL_SSD_REFRESH_INTERVAL_loader,
(void *)SSDMODEL_SSD_REFRESH_POLICY_loader,
(void *)SSDMODEL_SSD_VIRTUAL_RETENTION_PERIOD_loader,
(void *)SSDMODEL_SSD_MINIMUM_RETENTION_PERIOD_loader
};
...
SSDMODEL_SSD_CHECKPOINT_TIME_depend,
SSDMODEL_SSD_REFRESH_INTERVAL_depend,
SSDMODEL_SSD_REFRESH_POLICY_depend,
SSDMODEL_SSD_VIRTUAL_RETENTION_PERIOD_depend,
SSDMODEL_SSD_MINIMUM_RETENTION_PERIOD_depend
};
