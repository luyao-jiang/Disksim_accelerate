...
#ifndef DISKSIM_STAT_H
#define DISKSIM_STAT_H
...
/* functions exported by disksim_stat.c */

void   stat_initialize (FILE *statdef_file, const char *statdesc, statgen *statptr);
