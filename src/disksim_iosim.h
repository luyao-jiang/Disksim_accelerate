...
#define SSD_REFRESH_ELEMENT	             303
#define SSD_REFRESH_GANG		             304
...
void io_validate_do_stats2 (ioreq_event *_new);
...
static const char *statdesc_tracequeuestats =		"Trace queue time";
static const char *statdesc_tracerespstats =		"Trace response time";
static const char *statdesc_traceaccstats =		"Trace access time";
static const char *statdesc_traceqlenstats =		"Trace queue length";
static const char *statdesc_tracenoqstats =		"Trace non-queue time";
static const char *statdesc_traceaccdiffstats =	"Trace access diff time";
static const char *statdesc_traceaccwritestats =	"Trace write access time";
static const char *statdesc_traceaccdiffwritestats =	"Trace write access diff time";
