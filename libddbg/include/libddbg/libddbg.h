...
#define ddbg_assert(cond) do { long _ltassert_cond = (long)(cond); \
if(!_ltassert_cond) { \
...
/* print a message */
#ifndef _DDBG_DISABLE_ASSERTIONS
#define ddbg_assert2(cond,fmt) do { long _ltassert_cond = (long)(cond); \
if(!_ltassert_cond) { \
...
#ifndef _DDBG_DISABLE_ASSERTIONS
#define ddbg_assert3(cond,msg) do { long _ltassert_cond = (long)(cond);\
if(!_ltassert_cond) { \
 ddbg_assert_msg(__FILE__, __LINE__, #cond, __func__, ""); \
